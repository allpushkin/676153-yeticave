            ...
            <ul class="lots__list">
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?=$lot['picture'];?>" width="350" height="260" alt="<?=htmlspecialchars($lot['lot_title']);?>">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?=$lot['category_title'];?></span>
                        <h3 class="lot__title"><a class="text-link" href="lot.php?id=<?=$lot['id'];?>"><?=htmlspecialchars($lot['lot_title']);?></h3>
